...
class TvDetailScreen extends StatefulWidget {
  final TV tv;
  const TvDetailScreen({Key? key, required this.tv}) : super(key: key);
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: Center(child: Text(viewModel.tvDetail!.genres![index].name)),
          );
        },
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TvDetailScreen(tv: tv),
                              ),
                            );
                          },
